...
type
  ...
  published
    ...
    class function SetSpaces(const AWinControl: TWinControl; 
      LineSp, ParSp, RighSp: Integer): boolean; virtual;
...
class function TWSCustomRichMemo.SetSpaces(const AWinControl: TWinControl; LineSp, ParSp, RighSp: Integer): boolean;
begin
  // Added by Massimo Nardello
end;
