...
type
  ...
  public
    ...
    function SetSpaces(LineSp, ParSp, RighSp: Integer): boolean; virtual;
...
function TCustomRichMemo.SetSpaces(LineSp, ParSp, RighSp: Integer): boolean;
begin
  // Added by Massimo Nardello
  if HandleAllocated then begin
    Result := TWSCustomRichMemoClass(WidgetSetClass).SetSpaces(Self, LineSp, ParSp, RighSp);
  end else
   Result := False;
end;
